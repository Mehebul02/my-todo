...
export default function LoginPage() {
  ...
  return (
    <div className=" p-4">
      <div className="flex items-center justify-center min-h-screen  bg-white rounded-lg shadow-2xl ">
        {/* Left Side - Illustration Area */}
        <div>
          <Image src={signIn} alt="Login Illustration" width={600} height={500} />
        </div>
